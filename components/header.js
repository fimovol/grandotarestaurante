...
export default function Header(){
    ...
    <div className='flex justify-center items-center'>
        <div className='bg-green-500 inline-block p-2 rounded-full mr-2 md:mx-5'>
        ...
        <button className='capitalize bg-blue-700 text-white px-5 py-3 rounded-full'>contáctenos</button>
    </div>
